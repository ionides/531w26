...
y_full = pd.read_csv('google_returns_cleaned.csv')
y_full.set_index('Date', inplace=True)
y_full = y_full['Close']

hb = 4   # same value used in arch_model comparisons
y_cmp = y_full.iloc[hb:].copy()

N = len(y_cmp)

y_vals = y_cmp.to_numpy()
...
if __name__ == "__main__":
  ...
  outfile = outdir / "skewt_global_search_comparable.pkl"
