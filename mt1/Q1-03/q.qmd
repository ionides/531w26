...
Above are monthly injuries from motor vehicle collisions in New York City. An augmented Dickey-Fuller test, `adfuller(injuries)`, gives a p-value of `{python} f"{result[1]:3f}"`. Which is the best way to proceed:
