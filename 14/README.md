...
## Chapter 14. Likelihood for POMP models: Theory and practice

This chapter has some duplication with the background on likelihood-based inference (Chapter 5) and the background on POMP models (Chapter 11). These are fundamental topics, worth seeing again, but we will go over that fairly quickly to focus on the new material.
...
[Source code for these notes](http://github.com/pypomp/tutorials/tree/master/sbied/chapter3)
