...
entries <- rbind(
  ...
  c(format.Date(class_date[6]-1,format="%a %b %d"),
    "Homework 2 (needs chapter 3; chapter 4 to slide 15)."), 
...
#    "Class 13. Chapter 9 continued."),
  ...
  c(format.Date(class_date[13],format="%a %b %d"),
    "Class 13. Chapter 10. Forecasting. Start Chapter 11"),
  c(format.Date(class_date[14],format="%a %b %d"),
    "Class 14. Chapter 11. Introduction to POMP models, continued"),
  ...
  c(format.Date(class_date[15],format="%a %b %d"),
    "Class 15. Chapter 12. POMP models for ecology and epidemiology"),
  c(format.Date(class_date[16],format="%a %b %d"),
    "Class 16. Chapter 13. Simulation of stochastic models"),
  ...
  c(format.Date(class_date[17],format="%a %b %d"),
    "Class 17. Chapter 14. The particle filter"),
  c(format.Date(class_date[18],format="%a %b %d"),
    "Class 18. Chapter 14 continued"),
  c(format.Date(class_date[18]+4,format="%a %b %d"),
    "Homework 6 (using pypomp, needs chapter 12),"),    
  c(format.Date(class_date[19],format="%a %b %d"),
    "Class 19. Chapter 15. Parameter estimation by iterated filtering"),
  c(format.Date(class_date[20],format="%a %b %d"),
    "Class 20. Chapter 15 continued"),
  c(format.Date(class_date[21],format="%a %b %d"),
    "Class 21. Chapter 16. Start measles case study"),
    c(format.Date(class_date[22],format="%a %b %d"),
    "Class 22. Chapter 16 continued"),
 c(format.Date(class_date[22]+4,format="%a %b %d"),
    "Homework 7 (iterated filtering, needs chapter 15), due 11:59pm"),    
 c(format.Date(class_date[23],format="%a %b %d"),
    "Class 23. Chapter 16. Measles continued"),
  c(format.Date(class_date[24],format="%a %b %d"),
    "Class 24. Chapter 17. Financial volatility"),
   c(format.Date(class_date[24]+4,format="%a %b %d"),
    "Homework 8 (Progress report on final project),"),  
  c(format.Date(class_date[25],format="%a %b %d"),  
   "Class 25. Chapter 18. Ebola, forecasting and diagnostics"),
   c(format.Date(class_date[26],format="%a %b %d"),
    "Class 26. Midterm 2."),
  c(format.Date(class_date[27],format="%a %b %d"),
    "Class 27. Chapter 18. Ebola continued"),
...
STATS 531/631 W\Sexpr{format.Date(class1,format='%y')}. Provisional schedule \\
\end{center}
