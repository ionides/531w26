...
4. Sec 2.3 and 5. What is the value of studying the spectral entropy? It was not clear what was learned from this. The reviewers just passed over this section without comment, but the material should be better motivated or removed. For methods not studied in class, it is especially important to explain and motivate and refrence the approach. 
