...
plot_acf(huron_sarma11x10.resid[1:], ax=ax, lags=30)
plt.tight_layout()
plt.show()
```
...
- The optimization fails to find the maximum unless the covariate is centered by subtracting the mean. Optimization for ARMA models can be fragile!
...
- Section 3.8 of \textcite{shumway17} introduces regression with ARMA errors, calling it ARMAX.

- Section 5.3 of \textcite{huang22} presents regression with ARMA errors, calling it REGARMA.

- Section 9.3 of \textcite{huang22} discusses unit root tests.
