---
title: "Solution to [Homework 5](q.pdf)"
...
We start with the following facts: (1,2,4) are basic properties of probability; (3,6) are definitions of a POMP model; (5,7) come from the class notes [@notes531w26] using the hint in Chapter 11, slide 20.
