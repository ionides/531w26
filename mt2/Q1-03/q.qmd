...
Which of the following is a correct explanation of our options for properly implementing this in a POMP model called `mod`?

(A). The measurement times, `mod.ys.index`, should be in units of weeks, such as $1,2,\dots,104$.
...
(B). The measurement times, `mod.ys.index`, should be in units of weeks, such as $1,2,\dots,104$.
The latent process can be modeled using arbitrary time units, say days or weeks or years.
...
For example, we could use `mod.ys.index`=$1/52$, $2/52$, $\dots, 2$.
