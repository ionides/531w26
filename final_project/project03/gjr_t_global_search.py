...
def rproc_filt_gjr(X_: StateDict, theta_: ParamDict,
  ...
  H = (mu_h * (1 - phi) + phi * H
      ...
      + gamma * Y_state**2 * jnp.where(Y_state < 0, 1.0, 0.0) # gjr-garch type term
      + omega)
...
if __name__ == "__main__":
  ...
  outdir = Path("gjr_t_model_results")
  ...
  output = run_global_search(ys = ys,
        ...
        rproc = rproc_filt_gjr,
        dmeas = dmeas_t_errors,
        to_est = to_est_gjr_t,
        from_est = from_est_gjr_t,
        covars = covars,
        J1 = 2000,
        J2 = 2000,
        J3 = 2000,
  ...
  outfile = outdir / "gjr_t_global_search.pkl"
